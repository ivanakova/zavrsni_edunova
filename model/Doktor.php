...
class Doktor
{
    ...
    public static function ucitaj($sifra)
    {
        ...
        $izraz = $veza->prepare('SELECT b.sifra, b.ime, b.prezime, b.iban, a.naziv from ordinacija a 
                                inner join doktor b on a.sifra= b.ordinacija where b.sifra=:sifra');
    ...
    public static function promjena($entitet)
    {
        ...
        $izraz = $veza->prepare('update doktor set ime=:ime, prezime=:prezime, iban=:iban, ordinacija=:ordinacija where sifra=:sifra');
